# N20 (ESP32-S3) Pin Definitions

## Overview

The **N20** is an ESP32-S3 based energy monitoring controller. It communicates with two BL0910 energy measurement chips via an internal ARM CPU using UART, providing 20 channels of current/energy monitoring. The board includes Ethernet, I2C OLED, LoRa radio interface, SD card slot, and two free GPIOs.
...
- GPIO0 is not used on the N20 – avoid using it in your firmware.
