# FeedCurrent B24 (ESP32-S3) Pin Definitions
...
| :--- | :--- | :--- |
| PCF8575 (Input) | `0x22` | 16-bit I/O expander for inputs 1-16 |
| PCF8575 (Input/Output) | `0x25` | 16-bit I/O expander for inputs 17-24 and outputs 1-8 |
| PCF8575 (Output) | `0x24` | 16-bit I/O expander for outputs 9-24 |
| DS3231 RTC | `0x68` | Real-time clock |
| SSD1306 | `0x3C` | Display |
| ADS1115 | `0x48` | 4-channel ADC module |
| 24C02 EPROM | `0x50` | EEPROM storage |

#### PCF8575 (Input, Address `0x22`) Pin Mapping
...
#### PCF8575 (Input/Output, Address `0x25`) Pin Mapping
This chip reads inputs 17-24 and controls outputs 1-8.
| PCF8575 Pin | Connected Device | Type | Description |
| :--- | :--- | :--- | :--- |
...
#### PCF8575 (Output, Address `0x24`) Pin Mapping
