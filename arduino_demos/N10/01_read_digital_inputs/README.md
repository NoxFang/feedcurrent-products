# N10 Arduino Example 01: Read Digital Inputs

## Description
This example reads the state of two free digital input ports on the N10 board (GPIO15 and GPIO16) and prints their status to the Serial Monitor every 500 ms.

## File Structure
- `src/N10_01_read_digital_inputs.ino` – Arduino source code.
- `precompiled/N10_01_read_digital_inputs.bin` – Precompiled firmware binary for ESP32‑S3.

## Using the Precompiled Binary
Flash `precompiled/N10_01_read_digital_inputs.bin` to address `0x0` using ESP Flash Download Tool or `esptool.py`.
...
- The example reads only two GPIOs (15 and 16). For other free GPIOs, refer to Example 05 (if available) or modify the code.
