# N10 Arduino Example 04: Print Text on SSD1306 OLED Display
...
The display is connected via software I2C with SCL=GPIO17, SDA=GPIO18, address 0x3C.

## File Structure
- `src/N10_04_oled_ssd1306.ino` – Arduino source code.
- `precompiled/N10_04_oled_ssd1306.bin` – Precompiled firmware binary for ESP32‑S3.

## Using the Precompiled Binary
Flash `precompiled/N10_04_oled_ssd1306.bin` to address `0x0` using ESP Flash Download Tool or `esptool.py`.
