# N10 Arduino Example 05: Collect All Energy Meter Data (Modbus RTU)
...
## File Structure
- `src/N10_05_collect_all_data.ino` – Arduino source code.
- `precompiled/N10_05_collect_all_data.bin` – Precompiled firmware binary for ESP32‑S3.

## Using the Precompiled Binary
Flash `precompiled/N10_05_collect_all_data.bin` to address `0x0` using ESP Flash Download Tool or `esptool.py`.
...
The N10 board includes an onboard RS485 transceiver. No external module is required.
