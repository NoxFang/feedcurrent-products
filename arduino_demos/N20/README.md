# N20 Arduino Examples

This directory contains Arduino example sketches for the **FeedCurrent N20** controller. The N20 is based on the ESP32‑S3 and features RS485 Modbus data acquisition (up to 60 channels), SD card, Ethernet (W5500), OLED display, and free digital I/O.
...
The N20 uses the following key pins and I2C addresses:
...
For complete pin definitions, refer to `../pin_definitions/N20/N20_pin_definition.md`.
