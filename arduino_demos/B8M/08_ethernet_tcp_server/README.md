# FeedCurrent B8M Arduino Example 08: Ethernet W5500 TCP Server

## Description
This example sets up the W5500 Ethernet module as a TCP server on port 4196, echoing back any received data.

## File Structure
- `src/B8M_08_ethernet_tcp_server.ino` – Arduino source code.
- `precompiled/B8M_08_ethernet_tcp_server.bin` – Precompiled binary.

## Using the Precompiled Binary
Flash `precompiled/B8M_08_ethernet_tcp_server.bin` to `0x0`.
