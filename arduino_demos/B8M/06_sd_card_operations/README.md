# FeedCurrent B8M Arduino Example 06: How to Use SD Card

## Description
This example demonstrates basic SD card operations: mount, read/write/append/delete files, and performance test.

## File Structure
- `src/B8M_06_sd_card_operations.ino` – Arduino source code.
- `precompiled/B8M_06_sd_card_operations.bin` – Precompiled binary.

## Using the Precompiled Binary
Flash `precompiled/B8M_06_sd_card_operations.bin` to `0x0`.
