# B24 Arduino Examples

This directory contains 11 Arduino example sketches for the **KinCony B24** controller - a 24-channel relay controller based on ESP32-S3.

## B24 Hardware Overview
...
example_name/
├── src/
│   └── B24_XX_example_name.ino
├── precompiled/
│   └── B24_XX_example_name.bin
└── README.md
```
