# N30 Arduino Examples

This directory contains Arduino example sketches for the **FeedCurrent N30** controller. The N30 is based on the ESP32‑S3 and features RS485 Modbus data acquisition (up to 60 channels), SD card, Ethernet (W5500), OLED display, and free digital I/O.
...
The N30 uses the following key pins and I2C addresses:
...
For complete pin definitions, refer to `../pin_definitions/N30/N30_pin_definition.md`.
