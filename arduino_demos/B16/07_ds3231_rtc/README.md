# FeedCurrent B16 Arduino Example 07: How to Use DS3231 RTC Clock

## Description
This example shows how to read and set the DS3231 RTC via serial commands.

## File Structure
- `src/B16_07_ds3231_rtc.ino` – Arduino source code.
- `precompiled/B16_07_ds3231_rtc.bin` – Precompiled binary.

## Using the Precompiled Binary
Flash `precompiled/B16_07_ds3231_rtc.bin` to `0x0`.
