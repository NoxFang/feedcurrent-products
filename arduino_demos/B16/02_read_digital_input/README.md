# FeedCurrent B16 Arduino Example 02: Read Digital Input Ports State
...
## File Structure
- `src/B16_02_read_digital_input.ino` – Arduino source code.
- `precompiled/B16_02_read_digital_input.bin` – Precompiled binary.

## Using the Precompiled Binary
Flash `precompiled/B16_02_read_digital_input.bin` to `0x0`.
