# FeedCurrent B16 Arduino Example 09: Communication with Tuya WiFi Module
...
## File Structure
- `src/B16_09_tuya_communication.ino` – Arduino source code.
- `precompiled/B16_09_tuya_communication.bin` – Precompiled binary.

## Using the Precompiled Binary
Flash `precompiled/B16_09_tuya_communication.bin` to `0x0`.
