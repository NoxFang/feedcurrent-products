...
## File Structure
- `src/B16_01_turn_on_off.ino` – Arduino source code.
- `precompiled/B16_01_turn_on_off.bin` – Precompiled firmware binary for ESP32-S3.

## Using the Precompiled Binary
Flash `precompiled/B16_01_turn_on_off.bin` to address `0x0` using ESP Flash Download Tool or `esptool.py`.
...
## Important Notes
- **PCF8575 (Output)**: I2C address `0x22`, outputs connected to pins 0-15 (active LOW).
