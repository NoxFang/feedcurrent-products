# F16 Arduino Examples

This directory contains Arduino example sketches for the **FeedCurrent F16** controller. The F16 is based on the ESP32‑S3 and features 16 relay outputs (PCF8575 @ 0x25), 16 digital inputs (PCF8575 @ 0x24), 4 analog inputs (ESP32 internal ADC), Ethernet (W5500), RS485, RTC (DS3231), SD card, OLED display, and Tuya WiFi module.
...
| 11 | `11_input_trigger_output` | Directly links the 16 digital inputs to the 16 relay outputs (active‑LOW logic). |

## Common Hardware Configuration

The F16 uses the following key pins:
...
For complete pin definitions, refer to `../pin_definitions/F16/F16_pin_definition.md`.
