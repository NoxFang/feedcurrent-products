# N60 Arduino Example 04: Print Text on SSD1306 OLED Display
...
## File Structure
- `src/N60_04_oled_ssd1306.ino` – Arduino source code.
- `precompiled/N60_04_oled_ssd1306.bin` – Precompiled firmware binary for ESP32‑S3.

## Using the Precompiled Binary
Flash `precompiled/N60_04_oled_ssd1306.bin` to address `0x0` using ESP Flash Download Tool or `esptool.py`.
