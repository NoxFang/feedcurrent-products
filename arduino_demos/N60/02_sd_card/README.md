# N60 Arduino Example 02: SD Card Operations

## Description
This example demonstrates basic SD card file operations on the N60 board using the built‑in SPI interface. It automatically performs the following sequence:
...
## File Structure
- `src/N60_02_sd_card.ino` – Arduino source code.
- `precompiled/N60_02_sd_card.bin` – Precompiled firmware binary for ESP32‑S3.

## Using the Precompiled Binary
Flash `precompiled/N60_02_sd_card.bin` to address `0x0` using ESP Flash Download Tool or `esptool.py`.
