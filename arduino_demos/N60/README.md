# N60 Arduino Examples

This directory contains Arduino example sketches for the **FeedCurrent N60** controller. The N60 is based on the ESP32‑S3 and features RS485 Modbus data acquisition (up to 60 channels), SD card, Ethernet (W5500), OLED display, and free digital I/O.
...
- **Library modification**: After installing, modify the library header to handle large responses:
  ```cpp
...
The N60 uses the following key pins and I2C addresses:
...
For complete pin definitions, refer to `../pin_definitions/N60/N60_pin_definition.md`.
