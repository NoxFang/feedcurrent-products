# F4 Arduino Example 03: Read Analog Input Ports Value
...
## File Structure
- `src/F4_03_read_analog_inputs.ino` – Arduino source code.
- `precompiled/F4_03_read_analog_inputs.bin` – Precompiled firmware binary for ESP32‑S3.

## Using the Precompiled Binary
Flash `precompiled/F4_03_read_analog_inputs.bin` to address `0x0` using ESP Flash Download Tool or `esptool.py`.
