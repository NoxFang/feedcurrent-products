# T128M Arduino Example 07: I2C Scanner

## Description
This example scans two independent I2C buses on the T128M board and reports the addresses of all detected devices.  
...
## File Structure
- `src/T128M_07_i2c_scanner.ino` – Arduino source code.
- `precompiled/T128M_07_i2c_scanner.bin` – Precompiled firmware binary for ESP32‑S3.

## Using the Precompiled Binary
Flash `precompiled/T128M_07_i2c_scanner.bin` to address `0x0` using ESP Flash Download Tool or `esptool.py`.
