# DM32 Example 08: Ethernet W5500 TCP Server
...
## Usage
1. Connect an Ethernet cable between the DM32 and your router/switch.
2. Upload the sketch to the DM32 board.
3. Open the Serial Monitor at 115200 baud.
4. From a computer on the same network, connect to the DM32 using a TCP client (e.g., `telnet 192.168.3.55 4196` or `nc 192.168.3.55 4196`).
