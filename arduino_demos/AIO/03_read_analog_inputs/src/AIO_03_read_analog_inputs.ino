...
void setup() {
    ...
    Serial.println("AIO Example 03: Read Analog Input Ports Value");
    Serial.println("==============================================");
    Serial.println("Pin Configuration:");
    Serial.println("  A1 -> GPIO 5");
    Serial.println("  A2 -> GPIO 7");
    Serial.println("  A3 -> GPIO 6");
    Serial.println("  A4 -> GPIO 4");
    Serial.println("");
}
