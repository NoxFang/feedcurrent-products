# AIO Hybrid Arduino Example 10: Print Text on SSD1306 OLED Display
...
The display is connected via I2C (software implementation) with SCL=GPIO18, SDA=GPIO8, address `0x3C`.

## File Structure
- `src/AIO_10_oled_ssd1306.ino` – Arduino source code.
- `precompiled/AIO_10_oled_ssd1306.bin` – Precompiled firmware binary for ESP32‑S3 (to be added).
...
3. **Steps**:
   - Open `src/AIO_10_oled_ssd1306.ino` in Arduino IDE.
...
## Important Notes
- **I2C pins**: SCL=GPIO18, SDA=GPIO8 (software I2C implementation). This matches the AIO Hybrid hardware.
