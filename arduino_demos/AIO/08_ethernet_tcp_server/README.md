# AIO Hybrid Arduino Example 08: Ethernet W5500 TCP Server

## Description
This example sets up the W5500 Ethernet module on the AIO Hybrid board as a TCP server. It listens on port **4196** and echoes back any string received from a connected client. A static IP configuration is used.

## File Structure
- `src/AIO_08_ethernet_tcp_server.ino` – Arduino source code.
- `precompiled/AIO_08_ethernet_tcp_server.bin` – Precompiled firmware binary for ESP32‑S3 (to be added).
...
3. **Steps**:
   - Open `src/AIO_08_ethernet_tcp_server.ino` in Arduino IDE.
