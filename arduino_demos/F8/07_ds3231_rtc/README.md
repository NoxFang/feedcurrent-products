# F8 Arduino Example 07: DS3231 RTC Clock

## Description
This example demonstrates how to use the DS3231 Real‑Time Clock module on the F8 board. It initializes the RTC, reads the current date and time, and allows setting the time via serial commands.

## File Structure
- `src/F8_07_ds3231_rtc.ino` – Arduino source code.
- `precompiled/F8_07_ds3231_rtc.bin` – Precompiled firmware binary for ESP32‑S3.

## Using the Precompiled Binary
Flash `precompiled/F8_07_ds3231_rtc.bin` to address `0x0` using ESP Flash Download Tool or `esptool.py`.
...
| `DYYYY-MM-DDTHH:MM:SS` | Set the RTC date and time | `D2026-03-24T14:30:00` |

## Expected Output
On startup, the sketch prints the current time once:
Current time is: 2026-03-24 14:30:00
