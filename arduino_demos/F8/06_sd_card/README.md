# F8 Arduino Example 06: How to Use SD Card
...
## File Structure
- `src/F8_06_sd_card.ino` – Arduino source code.
- `precompiled/F8_06_sd_card.bin` – Precompiled firmware binary for ESP32‑S3.

## Using the Precompiled Binary
Flash `precompiled/F8_06_sd_card.bin` to address `0x0` using ESP Flash Download Tool or `esptool.py`.
...
- F8 board with on‑board SD card slot
