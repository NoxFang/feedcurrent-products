# F8 Arduino Example 08: Ethernet W5500 TCP Server
...
## File Structure
- `src/F8_08_ethernet_tcp_server.ino` – Arduino source code.
- `precompiled/F8_08_ethernet_tcp_server.bin` – Precompiled firmware binary for ESP32‑S3.

## Using the Precompiled Binary
Flash `precompiled/F8_08_ethernet_tcp_server.bin` to address `0x0` using ESP Flash Download Tool or `esptool.py`.
...
## Usage
1. Connect an Ethernet cable between the F8 and your router/switch.
2. Upload the sketch to the F8 board.
3. Open the Serial Monitor at 115200 baud.
4. From a computer on the same network, connect to the F8 using a TCP client (e.g., `telnet 192.168.3.55 4196` or `nc 192.168.3.55 4196`).
