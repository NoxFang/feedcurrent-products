# F8 Arduino Example 10: Print Text on SSD1306 OLED Display
...
## File Structure
- `src/F8_10_oled_ssd1306.ino` – Arduino source code.
- `precompiled/F8_10_oled_ssd1306.bin` – Precompiled firmware binary for ESP32‑S3.

## Using the Precompiled Binary
Flash `precompiled/F8_10_oled_ssd1306.bin` to address `0x0` using ESP Flash Download Tool or `esptool.py`.
