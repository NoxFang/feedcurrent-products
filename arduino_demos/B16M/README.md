# B16M Arduino Examples

This directory contains 11 Arduino example sketches for the **KinCony B16M** controller - a 16-channel relay controller based on ESP32-S3.

## B16M Hardware Overview

- **MCU**: ESP32-S3-WROOM-1U
- **Outputs**: 16 Channel Relay (via PCF8575 I2C expanders)
- **Inputs**: 16 Channel Digital Input (via PCF8575 I2C expanders)
...
Sequential control of 16 relay outputs.
...
example_name/
├── src/
│   └── B16M_XX_example_name.ino
├── precompiled/
│   └── B16M_XX_example_name.bin
└── README.md
```
