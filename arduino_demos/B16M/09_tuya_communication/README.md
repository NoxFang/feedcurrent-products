# FeedCurrent B16M Controller Arduino Example 09: Communication with Tuya WiFi Module
...
## File Structure
- `src/B16M_09_tuya_communication.ino` – Arduino source code.
- `precompiled/B16M_09_tuya_communication.bin` – Precompiled binary.

## Using the Precompiled Binary
Flash `precompiled/B16M_09_tuya_communication.bin` to `0x0`.
...
## Important Notes
- **Tuya pins**: TX=GPIO16, RX=GPIO17 (as defined in code).
