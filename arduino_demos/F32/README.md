# F32 Arduino Examples

This directory contains Arduino example sketches for the **FeedCurrent F32** controller. The F32 is based on the ESP32‑S3 and features 32 relay outputs (three PCF8575 expanders), 32 digital inputs (three PCF8575 expanders), 4 analog inputs (ESP32 internal ADC), Ethernet (W5500), RS485, RTC (DS3231), SD card, OLED display, and Tuya WiFi module.

## Available Examples

| # | Example Folder | Description |
|---|----------------|-------------|
| 01 | `01_turn_on_off_relay` | Sequentially turns on/off all 32 relays (first relays 1‑8, then 9‑16, then 17‑32) with a 200 ms delay. |
| 02 | `02_read_digital_inputs` | Reads the 32 digital input ports (inputs 1‑16 @ 0x24, inputs 17‑24 @ 0x26, inputs 25‑32 @ 0x27) and prints the binary state every 500 ms. |
...
| 11 | `11_input_trigger_output` | Directly links the 32 digital inputs to the 32 relay outputs (active‑LOW logic). |

## Common Hardware Configuration

The F32 uses the following key pins and I2C addresses:
...
| PCF8575 (inputs 17‑24) | Address 0x26, pins 0‑7 |
| PCF8575 (inputs 25‑32) | Address 0x27, pins 0‑7 |
| PCF8575 (relays 1‑8) | Address 0x27, pins 8‑15 |
| PCF8575 (relays 9‑16) | Address 0x26, pins 8‑15 |
| PCF8575 (relays 17‑32) | Address 0x25, pins 0‑15 |
...
For complete pin definitions, refer to `../pin_definitions/F32/F32_pin_definition.md`.
