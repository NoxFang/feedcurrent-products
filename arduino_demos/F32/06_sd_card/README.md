# F32 Arduino Example 06: SD Card Operations

## Description
This example demonstrates basic SD card file operations on the F32 board using the built‑in SPI interface. It automatically performs the following sequence:
...
## File Structure
- `src/F32_06_sd_card.ino` – Arduino source code.
- `precompiled/F32_06_sd_card.bin` – Precompiled firmware binary for ESP32‑S3.

## Using the Precompiled Binary
Flash `precompiled/F32_06_sd_card.bin` to address `0x0` using ESP Flash Download Tool or `esptool.py`.
