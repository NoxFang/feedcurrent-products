# F32 Arduino Example 07: DS3231 Real‑Time Clock
...
## File Structure
- `src/F32_07_ds3231_rtc.ino` – Arduino source code.
- `precompiled/F32_07_ds3231_rtc.bin` – Precompiled firmware binary for ESP32‑S3.

## Using the Precompiled Binary
Flash `precompiled/F32_07_ds3231_rtc.bin` to address `0x0` using ESP Flash Download Tool or `esptool.py`.
