...
## Overview
This example tests RS485 serial communication on the KinCony TA. It sends a message every second and prints any received data to the Serial Monitor.
...
4. Observe "Hello from KinCony TA!" sent every second
