...
* - The first line is "FEEDCURRENT" in a larger font.
* - The second line is "www.feedcurrent.com" in a smaller font.
*
...
void page1() {
  // Set font size 18 for the larger "FEEDCURRENT" text
  ...
  u8g2.print("FEEDCURRENT");              // Display the text "FEEDCURRENT" on the screen

  // Set font size 12 for the smaller "www.feedcurrent.com" text
  ...
  u8g2.print("www.feedcurrent.com");      // Display the text "www.feedcurrent.com"
}
