...
## File Structure
- `src/B8_01_sequential_on_off.ino` – Arduino source code.
- `precompiled/B8_01_sequential_on_off.bin` – Precompiled firmware binary for ESP32-S3.

## Using the Precompiled Binary
1. Download `B8_01_sequential_on_off.bin` from the `precompiled/` folder.
