# FeedCurrent B8 Controller Arduino Example 03: Read ADS1115 Analog Input Ports Value
...
## File Structure
- `src/B8_03_read_ads1115.ino` – Arduino source code.
- `precompiled/B8_03_read_ads1115.bin` – Precompiled binary.

## Using the Precompiled Binary
- Flash `precompiled/B8_03_read_ads1115.bin` to `0x0`.
