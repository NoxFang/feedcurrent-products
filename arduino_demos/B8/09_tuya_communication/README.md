# FeedCurrent B8 Controller Arduino Example 09: Communication with Tuya WiFi Module
...
## File Structure
- `src/B8_09_tuya_communication.ino` – Arduino source code.
- `precompiled/B8_09_tuya_communication.bin` – Precompiled binary.

## Using the Precompiled Binary
- Flash `precompiled/B8_09_tuya_communication.bin` to `0x0`.
...
- The `product_id` in the ESPHome config (if used) must match the one in the module.